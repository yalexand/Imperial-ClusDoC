...
function SAAstruct = SAA2col(obj,roi_index,save_dir,~)
...
RawData.Im1Pos = obj.get_ROI_data_MIiSR(roi_index,1);
RawData.Im2Pos = obj.get_ROI_data_MIiSR(roi_index,2);
...
saveas (figure(1), [roi_save_dir filesep Conditions.fName ' - ' Conditions.Ch1Label ' vs ' Conditions.Ch2Label '.fig']);
...
saveas (figure(2), [roi_save_dir filesep Conditions.fName ' - ' Conditions.Ch2Label ' vs ' Conditions.Ch1Label '.fig']);
...
%saveas (figure(3), ['SAA - ' Conditions.fName ' - Fraction Interacting of ' Conditions.Ch1Label ' and ' Conditions.Ch2Label '.fig']);
    saveas (figure(3), [roi_save_dir filesep Conditions.fName ' - Fraction Interacting of ' Conditions.Ch1Label ' and ' Conditions.Ch2Label '.fig']);
pause(0.5);
close (h);
...
%saveas (figure(4), ['SAA - ' Conditions.fName ' - Fold Enrichment of ' Conditions.Ch1Label ' and ' Conditions.Ch2Label '.fig']);
    saveas (figure(4), [roi_save_dir filesep Conditions.fName ' - Fold Enrichment of ' Conditions.Ch1Label ' and ' Conditions.Ch2Label '.fig']);
pause(0.5);
close (h);
...
%saveas (figure(5), ['SAA Net Data - ' Conditions.fName ' - ' Conditions.Ch1Label ' vs ' Conditions.Ch2Label '.pdf']);
    saveas (figure(5), [roi_save_dir filesep 'Net Data - ' Conditions.fName ' - ' Conditions.Ch1Label ' vs ' Conditions.Ch2Label '.fig']);
pause(0.5);
close (h);
