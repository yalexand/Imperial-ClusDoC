function [ClusterSmoothTableCh1, ClusterSmoothTableCh2, clusterIDOut, clusterTable] = DBSCANonDoCResults_YA( ...
    obj, CellData, Path_name, Chan1Color, Chan2Color, dbscanParamsPassed)
% Routine to apply DBSCAN on the Degree of Colocalisation Result for

ROICoordinates = obj.ROICoordinates;
NDatacolumns = obj.NDataColumns;
        ...
        cellROIPair = [];
            ...
            for roiIter = 1:length(ROICoordinates) % index for the region
                ...
                if ~isempty(Data)
                    ...
                    c = 1;
                    [~, ClusterCh, ~, classOut, ~, ~, ~, ResultCell{roiIter}] = obj.DBSCANHandler_YA( ...
                        Data_DoC1(:,5:6), ...
                        dbscanParams, ...
                        c, ...
                        roiIter, ...
                        ...
                        true, ...
                        clusterColor, ...
                        Data_DoC1(:, NDatacolumns + 2), ...
                        Data_DoC1(:, NDatacolumns + 6), ...
