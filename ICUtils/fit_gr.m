...
% % % % function [g_fit, L1 L2 n1 n2 p1 p2 N1 N2] = fit_gr(r,g_exp,N_locs,Area,mode)
% % % % 
% % % %                 ro = N_locs/Area;  
% % % %                 
% % % %                 if strcmp(mode,'Gaussian')
...
% % % %                         p1 = x(5);
% % % %                         p2 = 1 - p1;
% % % %                         g_fit = p1*F1(r,A1,L1) + p2*F2(r,A2,L2);
% % % %                      
% % % %                         L_min = min(L1,L2);
% % % %                         L_max = max(L1,L2);
% % % %                         if L_min==L1
...
% % % % end
% % % % %------------------------------------------------------------------
% % % % function g = g_theor_exp(r,A,L)
% % % %     g = 1 + A*exp(-r/L);
% % % % end
% % % % %------------------------------------------------------------------
% % % % function g = g_theor_Gauss(r,A,L)
% % % %     g = 1 + A*exp(-r.^2/(2*L^2));
% % % % end
% % % % %------------------------------------------------------------------
% % % % function [x,fval] = run_fitting_gr_5p(r,g_exp,fun1,fun2,p0)
