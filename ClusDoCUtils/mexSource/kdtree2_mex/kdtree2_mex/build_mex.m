...
% mex -v CXXFLAGS="$CXXFLAGS -fopenmp"
    ...
    mex -v -largeArrayDims CXXFLAGS="\$CXXFLAGS -fopenmp" CXXLIBS="\$CXXLIBS -fopenmp" -cxx kdtree2.o utils.o kdtree2rnearest.o -output kdtree2rnearest
    
%     mex -v kdtree2.o utils.o kdtree2rnearest.o -output kdtree2rnearest
