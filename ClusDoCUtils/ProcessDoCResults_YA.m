function ResultTable = ProcessDoCResults_YA(CellData, NDatacolumns, ROICoordinates, DensityROI, Path_name, ColoThres)
...
Result = struct('Correlation_Coloc1_vs_Density1', [], 'Correlation_Coloc2_vs_Density2', [], ...
            ...
            for reg = 1:length(ROICoordinates)
...
%                 whichPointsInROI = whichPointsInROI(:, reg) == '1';
                    ...
                    DataRaw = CellData(whichPointsInROI,:);
...
%%      
                ...
                GenericName=strcat('Table_',num2str(1),'_Region_',num2str(reg)); %t    
...
%                 D1_D2 = Data_DoC1.D1_D2; % Local Absolute Density per Channel
                ...
                if Plot2 == 1
                    ...
                    set(gca, 'box','on','XTickLabel',[],'XTick',[],'YTickLabel',[],'YTick',[])
                    set(gcf,'Color',[1 1 1])
                    saveas(gcf, fullfile(Path_name, f1, 'Raw_data_map_with_outliers_removed', strcat(GenericName ,'Outliers')), 'tif');
                    close gcf
                end
...
%                 Result.AvRela_DensityBelow04=mean(d(Colo<ColoThres)/DensityROI_temp(1));
               ...
               % Normalized density is normalized to max value in any point in ROI
                ...
                Result.AvRela_DensityAbove04 = mean(Data_DoC1((Data_DoC1(:,NDatacolumns + 4) >= ColoThres), NDatacolumns + 8)/DensityROI{reg}(1));
                Result.AvNorm_DensityBelow04 = mean(NormdDensity(Data_DoC1(:, NDatacolumns + 4) < ColoThres));
                Result.AvRela_DensityBelow04 = mean(Data_DoC1((Data_DoC1(:,NDatacolumns + 4) < ColoThres), NDatacolumns + 8)/DensityROI{reg}(1));
...
%                 D1 = Data_DoC1(Data_DoC1(:,12) == 1, NDatachannels + 6);
                Result.Av_Rela_Density_Ch1 = mean(D1 / DensityROI{reg}(2));
                ...
                Result.Av_Rela_DensityAbove04_Ch1 = mean(D1_above_04 / DensityROI{reg}(2));
...
%                 D1_below_04 = Data_DoC1.D1_D2((Data_DoC1.Ch == 1) & (Data_DoC1.DoC < ColoThres));
                ...
                Result.Av_Rela_DensityBelow04_Ch1 = mean(D1_below_04 / DensityROI{reg}(2));
...
%                 D2 = Data_DoC1.D1_D2(Data_DoC1.Ch == 2);
                Result.Av_Rela_Density_Ch2 = mean(D2 / DensityROI{reg}(3));
...
%                 D2_above_04 = Data_DoC1.D1_D2((Data_DoC1.Ch == 2) & (Data_DoC1.DoC >= ColoThres));
                ...
                Result.Av_Rela_DensityAbove04_Ch2 = mean(D2_above_04 / DensityROI{reg}(3));
...
%                 D2_below_04 = Data_DoC1.D1_D2((Data_DoC1.Ch == 2) & (Data_DoC1.DoC < ColoThres));
                ...
                Result.Av_Rela_DensityBelow04_Ch2 = mean(D2_below_04 / DensityROI{reg}(3));
                Result.AvNorm_DensityBelow04_Ch2 = mean(D2_below_04 / max(D2));
                

                ResultTable{reg} = Result;
                else
                    ResultTable{reg} = [];
